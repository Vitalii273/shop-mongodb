...
public class AdminController {
    ...
    public AddUnitResponseDto addCategory(@RequestBody CategoryDto dto, Principal principal){
        try {
    ...
    public AddUnitResponseDto addProduct(@RequestBody ProductDto dto, Principal principal){
    ...
    public RemoveResponseDto removeProductById(@PathVariable("id") String id, Principal principal){
...
//    }
    ...
    public UpdateUnitResponseDto updateCategory(@RequestBody CategoryDto categoryDto, Principal principal){
    ...
    public PriceResponseDto changeProductPrice(@RequestBody ProductDto productDto, Principal principal){
    ...
    public AddUserBalanceResponseDto addBalance(@RequestBody UserDto userDto, Principal principal){
